...
public final class ModData {
	public static final Codec<ShimmerSyringeItem.Variant> SHIMMER_VARIANT_CODEC = Codecs.rangedInt(0, ShimmerSyringeItem.Variant.values().length - 1).xmap(ShimmerSyringeItem.Variant::byIndex, ShimmerSyringeItem.Variant::getIndex);
	...
	public static final ComponentType<ShimmerSyringeItem.Variant> SHIMMER_VARIANT = RegisterHelper.componentType("shimmer_variant", builder -> builder.codec(SHIMMER_VARIANT_CODEC));
	...
	public static final AttachmentType<ShimmerSyringeItem.Variant> APPLIED_SHIMMER_VARIANT = RegisterHelper.persistentAttachmentType("applied_shimmer_variant", SHIMMER_VARIANT_CODEC, false);
