        ...
        CommandRegistrationCallback.EVENT.register((dispatcher, registryAccess, environment) -> {
            ...
            dispatcher.register(literal("tag-manager")
                .then(literal("add").then(CommandManager.argument("category", StringArgumentType.word()).then(CommandManager.argument("namespace", StringArgumentType.word()).then(CommandManager.argument("value", StringArgumentType.word()).executes(commandContext -> {
                    TagManager.add(Objects.requireNonNull(commandContext.getSource().getEntity()), new TagManager.TagCategory(StringArgumentType.getString(commandContext, "category")), Identifier.of(StringArgumentType.getString(commandContext, "namespace"), StringArgumentType.getString(commandContext, "value")));
                    ...
                    TagManager.put(Objects.requireNonNull(commandContext.getSource().getEntity()), new TagManager.TagCategory(StringArgumentType.getString(commandContext, "category")), Identifier.of(StringArgumentType.getString(commandContext, "namespace"), StringArgumentType.getString(commandContext, "value")));
                    ...
                    return r;
                        ...
                        TagManager.remove(Objects.requireNonNull(commandContext.getSource().getEntity()), new TagManager.TagCategory(StringArgumentType.getString(commandContext, "category")), Identifier.of(StringArgumentType.getString(commandContext, "namespace"), StringArgumentType.getString(commandContext, "value")));
