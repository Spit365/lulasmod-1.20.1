...
public class ModSpells {
	...
	public static final SpellItem SLASH_SPELL = RegisterHelper.spell("treachery_judecca", (world, player, hand, efficiencyMultiplier, cooldownMultiplier) -> {
	...
	public static final SpellItem FIRE_SPELL = RegisterHelper.spell("malignity", (world, player, hand, efficiencyMultiplier, cooldownMultiplier) -> {
	...
	public static final SpellItem DASH_SPELL = RegisterHelper.spell("purloining", (world, player, hand, efficiencyMultiplier, cooldownMultiplier) -> {
	...
	public static final SpellItem SMOKE_SPELL = RegisterHelper.spell("guile", (world, player, hand, efficiencyMultiplier, cooldownMultiplier) -> {
	...
	public static final SpellItem HEAL_SPELL = RegisterHelper.spell("appeasing", (world, player, hand, efficiencyMultiplier, cooldownMultiplier) -> {
		player.setHealth(player.getMaxHealth());
		player.getHungerManager().add(100, 0f);
		return 300;
	});
	public static final SpellItem BLOOD_SPELL = RegisterHelper.spell("emulations", (world, player, hand, efficiencyMultiplier, cooldownMultiplier) -> {
	...
	public static final SpellItem HOME_SPELL = RegisterHelper.spell("wickedness", (world, player, hand, efficiencyMultiplier, cooldownMultiplier) -> {
		ModMethods.sendHome(player, player.getStackInHand(hand).getItem());
		return 600;
	});
	public static final SpellItem POCKET_SPELL = RegisterHelper.spell("heresies", (world, player, hand, efficiencyMultiplier, cooldownMultiplier) -> {
	...
	public static final SpellItem AMETHYST_SPELL = RegisterHelper.spell("envy", (world, player, hand, efficiencyMultiplier, cooldownMultiplier) -> {
	...
	public static final SpellItem HIGHLIGHTER_SPELL = RegisterHelper.spell("highlighter_spell", (world, player, hand, efficiencyMultiplier, cooldownMultiplier) -> {
