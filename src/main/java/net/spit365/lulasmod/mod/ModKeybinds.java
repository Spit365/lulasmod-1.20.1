...
public final class ModKeybinds {
    ...
    public static final KeyBinding BREAK_WITH_MIND = ClientRegisterHelper.keyBinding("break_with_mind", GLFW.GLFW_KEY_G);
	...
	public static void init(){
        ClientTickEvents.END_CLIENT_TICK.register(client -> {
            ...
            if (ModKeybinds.BREAK_WITH_MIND.wasPressed()) ClientPlayNetworking.send(new BreakWithMindC2SPacket());
        });
    }
}
