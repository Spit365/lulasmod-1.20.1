...
public class ModClient {
     private static class register{
          private static <T extends Entity> EntityType<T> Entity(String id, EntityType.EntityFactory<T> entityFactory, EntityRendererFactory<T> entityRendererFactory, float width, float height, int maxTrackingRange, int trackingTickInterval) {
               EntityType<T> entityType = Registry.register(Registries.ENTITY_TYPE, Identifier.of(Server.MOD_ID, id),
                       EntityType.Builder.create(entityFactory, SpawnGroup.MISC)
                               ...
                               .build(Identifier.of(Server.MOD_ID, id).toString()));
     ...
     public static class Particles {
          public static final ParticleEffect SCRATCH = register.Particle("scratch", true, SweepAttackParticle.Factory::new);
          public static final ParticleEffect GOLDEN_SHIMMER = register.Particle("golden_shimmer", false, FlameParticle.Factory::new);
          public static final ParticleEffect CURSED_BLOOD = register.Particle("cursed_blood", false, FlameParticle.Factory::new);
          public static final ParticleEffect EXPLOSION = register.Particle("explosion", false, ExplosionLargeParticle.Factory::new);
