...
public class SmokeBombEntity extends ThrownItemEntity {
	...
	public SmokeBombEntity(World world, LivingEntity owner) {
        super(ModEntities.SMOKE_BOMB, world);
    ...
    @Override protected void onBlockHit(BlockHitResult blockHitResult) {collision(blockHitResult.getPos().add(Vec3d.of(blockHitResult.getSide().getVector())));}
