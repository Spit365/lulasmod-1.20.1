...
public final class SpellHotbarRenderer {
    private static final ResourceLocation SPELL_HOTBAR_TEXTURE = ResourceLocation.fromNamespaceAndPath(Lulasmod.MOD_ID, "textures/gui/spell_hotbar.png");
    ...
    public static void render(GuiGraphics context) {
        ...
        for (int i = 0; i < Math.min(spellHotbarList.size(), 3); i++)
            context.renderItem(spellHotbarList.get(i), x + 4, y + (i * -20));
    }
}
