...
public class LasciviousnessItem extends Item {
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity player, Hand hand){
        if (!world.isClient()) {
            ...
            TagManager.put(player, ModTagCategories.SYMBIOSIS, String.valueOf(selectedEntity.getId()));
    ...
    public boolean postHit(ItemStack stack, LivingEntity target, LivingEntity attacker){
        ...
        Entity temp = attacker.getWorld().getEntityById(Integer.parseInt(Objects.requireNonNull(TagManager.read(attacker, ModTagCategories.SYMBIOSIS))));
