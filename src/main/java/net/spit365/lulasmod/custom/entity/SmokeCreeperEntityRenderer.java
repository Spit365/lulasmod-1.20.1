...
public class SmokeCreeperEntityRenderer extends MobEntityRenderer<CreeperEntity, CreeperEntityModel<CreeperEntity>> {
	private static final Identifier TEXTURE = new Identifier(Lulasmod.MOD_ID,"textures/entity/smoke_creeper/smoke_creeper.png");

	public SmokeCreeperEntityRenderer(EntityRendererFactory.Context context) {
