package net.spit365.lulasmod.custom.entity.model;
...
public class TailModel<T extends LivingEntity> extends SinglePartEntityModel<T> {
	...
	public static final Identifier TEXTURE = Identifier.of(Server.MOD_ID, "textures/entity/tail_feature.png");
	...
	@Override public void render(MatrixStack matrices, VertexConsumer vertexConsumer, int light, int overlay, int color) {
