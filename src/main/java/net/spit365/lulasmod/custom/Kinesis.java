...
public class Kinesis {
	...
	public static void render(DrawContext context, RenderTickCounter renderTickCounter) {
		...
		if (Arrays.stream(Hand.values()).anyMatch(hand -> player.getStackInHand(hand).getItem() instanceof SpellHotbar) && !ModGui.SPELL_HOTBAR_LIST.isEmpty() && ModGui.SPELL_HOTBAR_LIST.getFirst().isOf(ModSpells.KINESIS_SORCERY)) {
